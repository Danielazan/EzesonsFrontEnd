import {
  ...
  const Invoice = ({ navigation }) => {
    ...
    const {products, 
        setProducts, refreash, setRefreash, EditQty, setEditQty,invoices, 
        setInvoices } =
    ...
    const fetchCustomers = async (Page) => {
      try {
        const response = await axios.get(`${URL}/api/salesLedgerbypage?page=${Page}&size=${150}`);
          ...
          >
            ...
            >
              ...
              >
                ...
                <Text
                  style={{ fontSize: ms(15), color: "#000000", fontWeight: 400 }}
                >
                  {item.CustomersName}
                </Text>
              </View>
              ...
              >
                ...
                >
                  <Text
                    style={{ fontSize: s(20), fontWeight: 800, color: "#000000" }}
                  >
                    Items Bought
                  </Text>
                </TouchableOpacity>
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <Text style={{ fontSize: hp(2), color: "#0E2D63", fontWeight: 800 }}>
              {" "}
              Eze & Sons
            </Text>
          </View>
  
          <Text style={{ fontSize: hp(2), color: "white", fontWeight: 800 }}>
            Invioce
          </Text>
