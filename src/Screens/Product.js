import {
  ...
  const Index = ({ navigation }) => {
    ...
    const { Name, products, setProducts, refreash, setRefreash, EditQty, setEditQty } =
    ...
    const fetchProducts = async (Page) => {
      ...
      try {
        const response = await axios.get(`${URL}/api/productpage?page=${Page}&size=5`);
    ...
    const openCameraLib = async (item, index) => {
      ...
      const NewData = await products.map((e, idk) => {
        if (item.id === e.id) {
          return {
            ...e,
    ...
    const handleSearch = async (query, Page) => {
      ...
      if (!formattedQuery) {
        // If the search query is empty, reset to the full dataset or display an error message
        initalLoad(); // Reset to full dataset
        console.log("Search query is empty. Showing all data.");
        return;
      }
    ...
    const renderItem = ({ item, index }) => {
      return (
        ...
        >
          ...
          {/* Line (yellow) */}
          <View
            style={{ width: "80%", height: "0.5%", backgroundColor: "white" }}
          ></View>
          ...
          >
            ...
            >
              ...
              <Text
                style={{ fontSize: ms(15), color: "#6DB6ED", fontWeight: 400 }}
              >
                {item.Name}
              </Text>
            </View>
            ...
            >
              ...
              <Text
                style={{ fontSize: ms(15), color: "#6DB6ED", fontWeight: 400 }}
              >
               {item.Branches ? item.Branches[0].BranchName : "Main Branch"}
              </Text>
            </View>
            ...
            >
              ...
              <Text
                style={{ fontSize: ms(12), color: "#6DB6ED", fontWeight: 400 }}
              >
          ...
          >
             <MaterialCommunityIcons name="dots-horizontal-circle" size={24} color="#FFFFFF" />
          </TouchableOpacity>
  
          {
            ...
            >
              ...
              >
                ...
                >
                  <Text
                    style={{ fontSize: wp(3), color: "white", fontWeight: 600 }}
                  >
                    Add Quantity
                  </Text>
              ...
              >
                ...
                >
                  <Text
                    style={{ fontSize: wp(3.5), color: "white", fontWeight: 600 }}
                  >
                    Change Image
                  </Text>
          ...
          >
            <Text style={{color:"white", fontWeight:800}}>Change Image</Text>
            <ImageBackground
              style={{
                width: 100,
                height: 100,
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <Text style={{ fontSize: hp(2), color: "#0E2D63", fontWeight: 600 }}>
              {" "}
              Eze & Sons
            </Text>
          </View>
  
          <Text style={{ fontSize: hp(2), color: "black", fontWeight: 800 }}>
            Products
          </Text>
        ...
        {!Model && (
          ...
          >
            <Entypo name="dribbble-with-circle" size={50} color="white" />
          </TouchableOpacity>
        )}
